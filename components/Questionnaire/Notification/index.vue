      ...
      <div class="notification__content--position">
        ...
        <div v-if="level === 4" class="notification__content--container">
          <div class="notification__content-message">
            ...
            <p>
              Form harus diisi sebelum <span class="notification__content-message--bold">tanggal 8 Juli 2022 pukul 17:00 WIB.</span> Jika terpilih, Tim Desa Digital akan menghubungi Anda untuk proses selanjutnya.
            </p>
          </div>
          <div class="notification__content-info">
