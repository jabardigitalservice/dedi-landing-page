...
export const actions = {
  showDialog ({ commit }, payload) {
    ...
    commit('SET_BUTTON_LEFT_LABEL', payload.btnLeftLabel)
    commit('SET_BUTTON_RIGHT_LABEL', payload.btnRightLabel)
  ...
  closeDialog ({ commit }) {
    ...
    commit('SET_BUTTON_LEFT_LABEL', 'Tidak')
    commit('SET_BUTTON_RIGHT_LABEL', 'Ya')
